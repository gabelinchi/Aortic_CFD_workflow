function [F_new,V_new] = cutVessel_bifurcation(F_fs,V_fs,F_inlet,V_inlet,F_outlet1,V_outlet1,F_outlet2,V_outlet2) 

[F_new,V_new] = Subtraction(F_fs,V_fs,F_inlet,V_inlet,1,1);
[F_new,V_new] = Subtraction(F_new,V_new,F_outlet1,V_outlet1,2,2);
[F_new,V_new] = Subtraction(F_new,V_new,F_outlet2,V_outlet2,1,2);
...
function [F_out,V_out] = Subtraction(F_in,V_in,F_ref,V_ref,typex,typez) %type = 1 or 2, depending on that the bias for the cylinder is set tu -bias (inverted) - this quantity is used for translation of the cylinder used for boolean operation (in function subtraction)
